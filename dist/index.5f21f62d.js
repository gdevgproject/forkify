function e(e){return e&&e.__esModule?e.default:e}var t,r,n,i=globalThis,a={},s={},o=i.parcelRequire94c2;null==o&&((o=function(e){if(e in a)return a[e].exports;if(e in s){var t=s[e];delete s[e];var r={id:e,exports:{}};return a[e]=r,t.call(r.exports,r,r.exports),r.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){s[e]=t},i.parcelRequire94c2=o),(0,o.register)("27Lyk",function(e,t){Object.defineProperty(e.exports,"register",{get:()=>r,set:e=>r=e,enumerable:!0,configurable:!0});var r,n=new Map;r=function(e,t){for(var r=0;r<t.length-1;r+=2)n.set(t[r],{baseUrl:e,path:t[r+1]})}}),o("27Lyk").register(new URL("",import.meta.url).toString(),JSON.parse('["f9fpV","index.5f21f62d.js","eyyUD","icons.c5b0f01c.svg"]'));const c="https://forkify-api.herokuapp.com/api/v2/recipes/",d="c15d7846-dfe0-415c-b0f3-42f19f0a3f46",l=async function(e,t){try{let r=t?fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}):fetch(e),n=await Promise.race([r,new Promise(function(e,t){setTimeout(function(){t(Error("Request took too long! Timeout after 10 second"))},1e4)})]),i=await n.json();if(!n.ok)throw Error(`${i.message} (${n.status})`);return i}catch(e){throw e}},u={recipe:{},search:{query:"",results:[],page:1,resultsPerPage:10},bookmarks:[]},p=function(e){let{recipe:t}=e.data;return{id:t.id,title:t.title,publisher:t.publisher,sourceUrl:t.source_url,image:t.image_url,servings:t.servings,cookingTime:t.cooking_time,ingredients:t.ingredients,...t.key&&{key:t.key}}},h=async function(e){try{let t=await l(`${c}${e}?key=${d}`);u.recipe=p(t),u.bookmarks.some(t=>t.id===e)?u.recipe.bookmarked=!0:u.recipe.bookmarked=!1,console.log(u.recipe)}catch(e){throw console.error(`${e} \u{1F4A5}\u{1F4A5}\u{1F4A5}\u{1F4A5}`),e}},m=async function(e){try{u.search.query=e;let t=await l(`${c}?search=${e}&key=${d}`);console.log(t),u.search.results=t.data.recipes.map(e=>({id:e.id,title:e.title,publisher:e.publisher,image:e.image_url,...e.key&&{key:e.key}})),u.search.page=1}catch(e){throw console.error(`${e} \u{1F4A5}\u{1F4A5}\u{1F4A5}\u{1F4A5}`),e}},g=function(e=u.search.page){u.search.page=e;let t=(e-1)*u.search.resultsPerPage,r=e*u.search.resultsPerPage;return u.search.results.slice(t,r)},_=function(e){u.recipe.ingredients.forEach(t=>{t.quantity=t.quantity*e/u.recipe.servings}),u.recipe.servings=e},f=function(){localStorage.setItem("bookmarks",JSON.stringify(u.bookmarks))},v=function(e){u.bookmarks.push(e),e.id===u.recipe.id&&(u.recipe.bookmarked=!0),f()},b=function(e){let t=u.bookmarks.findIndex(t=>t.id===e);u.bookmarks.splice(t,1),e===u.recipe.id&&(u.recipe.bookmarked=!1),f()};!function(){let e=localStorage.getItem("bookmarks");e&&(u.bookmarks=JSON.parse(e))}();const k=async function(e){try{let t=Object.entries(e).filter(e=>e[0].startsWith("ingredient")&&""!==e[1]).map(e=>{let t=e[1].split(",").map(e=>e.trim());if(3!==t.length)throw Error("Wrong ingredient fromat! Please use the correct format :)");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={title:e.title,source_url:e.sourceUrl,image_url:e.image,publisher:e.publisher,cooking_time:+e.cookingTime,servings:+e.servings,ingredients:t},n=await l(`${c}?key=${d}`,r);u.recipe=p(n),v(u.recipe)}catch(e){throw e}};var y={};y=new URL("icons.c5b0f01c.svg",import.meta.url).toString();class w{_data;render(e,t=!0){if(!e||Array.isArray(e)&&0===e.length)return this.renderError();this._data=e;let r=this._generateMarkup();if(!t)return r;this._clear(),this._parentElement.insertAdjacentHTML("afterbegin",r)}update(e){this._data=e;let t=this._generateMarkup(),r=Array.from(document.createRange().createContextualFragment(t).querySelectorAll("*")),n=Array.from(this._parentElement.querySelectorAll("*"));r.forEach((e,t)=>{let r=n[t];e.isEqualNode(r)||e.firstChild?.nodeValue.trim()===""||(r.textContent=e.textContent),e.isEqualNode(r)||Array.from(e.attributes).forEach(e=>r.setAttribute(e.name,e.value))})}_clear(){this._parentElement.innerHTML=""}renderSpinner(){let t=`
  ...
  `}}var E=new $;class F{_parentEl=document.querySelector(".search");getQuery(){let e=this._parentEl.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){this._parentEl.querySelector(".search__field").value=""}addHandlerSearch(e){this._parentEl.addEventListener("submit",function(t){t.preventDefault(),e()})}}var S=new F,M=new class extends w{_parentElement="";_generateMarkup(){let t=window.location.hash.slice(1);return`
    ...
    `}};class H extends w{_parentElement=document.querySelector(".results");_errorMessage="No recipes found for your query! Please try again ;)";_message="";_generateMarkup(){return this._data.map(e=>M.render(e,!1)).join("")}}var q=new H;class A extends w{_parentElement=document.querySelector(".pagination");addHandlerClick(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--inline");r&&e(+r.dataset.goto)})}_generateMarkup(){let t=this._data.page,r=Math.ceil(this._data.results.length/this._data.resultsPerPage);return 1===t&&r>1?`
      ...
      `:""}}var x=new A;class L extends w{_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet. Find a nice recipe and bookmark it ;)";_message="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkup(){return this._data.map(e=>M.render(e,!1)).join("")}}var P=new L;class T extends w{_parentElement=document.querySelector(".upload");_message="Recipe was successfully uploaded :)";_window=document.querySelector(".add-recipe-window");_overlay=document.querySelector(".overlay");_btnOpen=document.querySelector(".nav__btn--add-recipe");_btnClose=document.querySelector(".btn--close-modal");constructor(){super(),this._addHandlerShowWindow(),this._addHandlerHideWindow()}toggleWindow(){this._overlay.classList.toggle("hidden"),this._window.classList.toggle("hidden")}_addHandlerShowWindow(){this._btnOpen.addEventListener("click",this.toggleWindow.bind(this))}_addHandlerHideWindow(){this._btnClose.addEventListener("click",this.toggleWindow.bind(this)),this._overlay.addEventListener("click",this.toggleWindow.bind(this))}addHandlerUpload(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault(),e(Object.fromEntries([...new FormData(this)]))})}_generateMarkup(){}}var R=new T;const j=async function(){try{let e=window.location.hash.slice(1);if(!e)return;E.renderSpinner(),q.update(g()),P.update(u.bookmarks),await h(e),E.render(u.recipe)}catch(e){E.renderError(),console.error(e)}},N=async function(){try{q.renderSpinner();let e=S.getQuery();if(!e)return;await m(e),q.render(g()),x.render(u.search)}catch(e){console.log(e)}},O=async function(e){try{R.renderSpinner(),await k(e),console.log(u.recipe),E.render(u.recipe),R.renderMessage(),P.render(u.bookmarks),window.history.pushState(null,"",`#${u.recipe.id}`),setTimeout(function(){R.toggleWindow()},2500)}catch(e){console.error("\uD83D\uDCA5",e),R.renderError(e.message)}};P.addHandlerRender(function(){P.render(u.bookmarks)}),E.addHandlerRender(j),E.addHandlerUpdateServings(function(e){_(e),E.update(u.recipe)}),E.addHandlerAddBookmark(function(){u.recipe.bookmarked?b(u.recipe.id):v(u.recipe),E.update(u.recipe),P.render(u.bookmarks)}),S.addHandlerSearch(N),x.addHandlerClick(function(e){q.render(g(e)),x.render(u.search)}),R.addHandlerUpload(O);
//# sourceMappingURL=index.5f21f62d.js.map
